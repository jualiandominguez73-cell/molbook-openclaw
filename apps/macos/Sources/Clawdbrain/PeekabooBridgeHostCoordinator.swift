...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.clawdbrain", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: ClawdbrainPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = ClawdbrainPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.clawdbrainSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.clawdbrainSocketPath, privacy: .public)")
    }
...
@MainActor
private final class ClawdbrainPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.clawdbrain.peekaboo")
