...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ClawdbrainConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - Clawdbrain Workspace
