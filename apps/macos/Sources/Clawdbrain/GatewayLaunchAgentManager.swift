...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".clawdbrain/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.clawdbrainCommand(
            subcommand: "gateway",
