...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.clawdbrain", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.clawdbrain", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ClawdbrainChatMessage] = messages.compactMap { item in
