...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.clawdbrain", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Clawdbrain windows, but below the system’s pop-up menus.
