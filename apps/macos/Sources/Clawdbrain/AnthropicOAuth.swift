...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Clawdbrain token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ClawdbrainOAuthStore.AnthropicOAuthStatus = ClawdbrainOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "anthropic-oauth")
...
enum ClawdbrainOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let clawdbrainOAuthDirEnv = "CLAWDBRAIN_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Clawdbrain OAuth token file not found"
            case .unreadableFile: "Clawdbrain OAuth token file not readable"
            case .invalidJSON: "Clawdbrain OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Clawdbrain OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Clawdbrain OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.clawdbrainOAuthDirEnv]?
