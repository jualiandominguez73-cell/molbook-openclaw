...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ClawdbrainPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ClawdbrainPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
