...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Clawdbrain/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__clawdbrain__/a2ui/").absoluteString + "?platform=macos"
    }
