...
enum UIStrings {
    static let welcomeTitle = "Welcome to Clawdbrain"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "clawdbrain.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ClawdbrainOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ClawdbrainChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g clawdbrain@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ClawdbrainChatViewModel(
