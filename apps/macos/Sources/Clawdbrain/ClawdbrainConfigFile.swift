...
enum ClawdbrainConfigFile {
    private static let logger = Logger(subsystem: "com.clawdbrain", category: "config")

    static func url() -> URL {
        ClawdbrainPaths.configURL
    }

    static func stateDirURL() -> URL {
        ClawdbrainPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ClawdbrainPaths.workspaceURL
    }
