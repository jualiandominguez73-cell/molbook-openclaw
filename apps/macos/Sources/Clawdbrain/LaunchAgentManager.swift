...
enum LaunchAgentManager {
    private static let legacyLaunchdLabel = "com.steipete.clawdbrain"
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/com.clawdbrain.mac.plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>com.clawdbrain.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/Clawdbrain</string>
          </array>
