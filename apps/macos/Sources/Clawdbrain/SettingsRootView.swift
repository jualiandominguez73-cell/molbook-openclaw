...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .clawdbrainSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ClawdbrainPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ClawdbrainPaths.stateDirURL.path
...
extension Notification.Name {
    static let clawdbrainSelectSettingsTab = Notification.Name("clawdbrainSelectSettingsTab")
}
