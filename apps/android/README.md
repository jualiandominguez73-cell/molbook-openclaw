## Clawdbrain Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_clawdbrain-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm clawdbrain gateway --port 18789 --verbose
```
