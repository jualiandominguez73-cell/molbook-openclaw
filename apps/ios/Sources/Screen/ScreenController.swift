...
final class ScreenController {
    ...
    /// Callback invoked when a clawdbrain:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ClawdbrainKitResources.bundle
...
/// Handles navigation policy to intercept clawdbrain:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept clawdbrain:// deep links
        if url.scheme == "clawdbrain" {
