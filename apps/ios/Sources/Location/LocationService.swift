...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: ClawdbrainLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: ClawdbrainLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: ClawdbrainLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
