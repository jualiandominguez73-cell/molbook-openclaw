...
public enum ClawdbrainBonjour {
    // v0: internal-only, subject to rename.
    public static let gatewayServiceType = "_clawdbrain-gw._tcp"
    public static let gatewayServiceDomain = "local."
    public static let wideAreaGatewayServiceDomain = "clawdbrain.internal."
