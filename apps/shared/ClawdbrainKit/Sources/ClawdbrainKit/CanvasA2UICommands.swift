...
public enum ClawdbrainCanvasA2UICommand: String, Codable, Sendable {
...
public struct ClawdbrainCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ClawdbrainCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
