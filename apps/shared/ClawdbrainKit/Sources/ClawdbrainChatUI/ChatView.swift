...
@MainActor
public struct ClawdbrainChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ClawdbrainChatViewModel
    ...
    public init(
        viewModel: ClawdbrainChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                ClawdbrainChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [ClawdbrainChatMessage] {
        let base: [ClawdbrainChatMessage]
    ...
    private func mergeToolResults(in messages: [ClawdbrainChatMessage]) -> [ClawdbrainChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ClawdbrainChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ClawdbrainChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ClawdbrainChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ClawdbrainChatMessage) -> String {
