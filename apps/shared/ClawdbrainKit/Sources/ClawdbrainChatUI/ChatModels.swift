...
public typealias ClawdbrainPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ClawdbrainPlatformImage = UIImage
#endif

public struct ClawdbrainChatUsageCost: Codable, Hashable, Sendable {
...
public struct ClawdbrainChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ClawdbrainChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ClawdbrainChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ClawdbrainChatMessageContent: Codable, Hashable, Sendable {
...
public struct ClawdbrainChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ClawdbrainChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ClawdbrainChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ClawdbrainChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ClawdbrainChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ClawdbrainChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ClawdbrainChatMessageContent].self, forKey: .content) {
...
public struct ClawdbrainChatHistoryPayload: Codable, Sendable {
...
public struct ClawdbrainSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ClawdbrainSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ClawdbrainSessionPreviewItem]
}

public struct ClawdbrainSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ClawdbrainSessionPreviewEntry]

    public init(ts: Int, previews: [ClawdbrainSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ClawdbrainChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ClawdbrainChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ClawdbrainAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ClawdbrainChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ClawdbrainGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ClawdbrainPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ClawdbrainPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: ClawdbrainPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct ClawdbrainChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
