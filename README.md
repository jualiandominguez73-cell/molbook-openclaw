# 🦞 Clawdbrain — Personal AI Assistant

<p align="center">
  <img src="https://raw.githubusercontent.com/clawdbrain/clawdbrain/main/docs/whatsapp-clawd.jpg" alt="Clawdbrain" width="400">
</p>
...
<p align="center">
  <a href="https://github.com/clawdbrain/clawdbrain/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/clawdbrain/clawdbrain/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/clawdbrain/clawdbrain/releases"><img src="https://img.shields.io/github/v/release/clawdbrain/clawdbrain?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://deepwiki.com/clawdbrain/clawdbrain"><img src="https://img.shields.io/badge/DeepWiki-clawdbrain-111111?style=for-the-badge" alt="DeepWiki"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Clawdbrain** is a *personal AI assistant* you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://clawdbrain.bot) · [Docs](https://docs.clawdbrain.bot) · [Getting Started](https://docs.clawdbrain.bot/start/getting-started) · [Updating](https://docs.clawdbrain.bot/install/updating) · [Showcase](https://docs.clawdbrain.bot/start/showcase) · [FAQ](https://docs.clawdbrain.bot/start/faq) · [Wizard](https://docs.clawdbrain.bot/start/wizard) · [Nix](https://github.com/clawdbrain/nix-clawdbrain) · [Docker](https://docs.clawdbrain.bot/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`clawdbrain onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.clawdbrain.bot/start/getting-started)

**Subscriptions (OAuth):**
- **[Anthropic](https://www.anthropic.com/)** (Claude Pro/Max)
- **[OpenAI](https://openai.com/)** (ChatGPT/Codex)

Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.clawdbrain.bot/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.clawdbrain.bot/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.clawdbrain.bot/concepts/model-failover)
...
# or: pnpm add -g clawdbrain@latest

clawdbrain onboard --install-daemon
```

The wizard installs the Gateway daemon (launchd/systemd user service) so it stays running.
Legacy note: `clawdbrain` remains available as a compatibility shim.

## Quick start (TL;DR)

Runtime: **Node ≥22**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.clawdbrain.bot/start/getting-started)

```bash
clawdbrain onboard --install-daemon

clawdbrain gateway --port 18789 --verbose

# Send a message
clawdbrain message send --to +1234567890 --message "Hello from Clawdbrain"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
clawdbrain agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.clawdbrain.bot/install/updating) (and run `clawdbrain doctor`).
...
Switch channels (git + npm): `clawdbrain update --channel stable|beta|dev`.
Details: [Development channels](https://docs.clawdbrain.bot/install/development-channels).
...
pnpm clawdbrain onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm clawdbrain ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `clawdbrain` binary.

## Security defaults (DM access)

Clawdbrain connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.clawdbrain.bot/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:
- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `clawdbrain pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `clawdbrain doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.clawdbrain.bot/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.clawdbrain.bot/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.clawdbrain.bot/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.clawdbrain.bot/nodes/voicewake) + [Talk Mode](https://docs.clawdbrain.bot/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.clawdbrain.bot/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.clawdbrain.bot/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.clawdbrain.bot/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.clawdbrain.bot/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.clawdbrain.bot/nodes).
- **[Onboarding](https://docs.clawdbrain.bot/start/wizard) + [skills](https://docs.clawdbrain.bot/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=clawdbrain/clawdbrain&type=date&legend=top-left)](https://www.star-history.com/#clawdbrain/clawdbrain&type=date&legend=top-left)

## Everything we built so far

### Core platform
- [Gateway WS control plane](https://docs.clawdbrain.bot/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.clawdbrain.bot/web), and [Canvas host](https://docs.clawdbrain.bot/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.clawdbrain.bot/tools/agent-send): gateway, agent, send, [wizard](https://docs.clawdbrain.bot/start/wizard), and [doctor](https://docs.clawdbrain.bot/gateway/doctor).
- [Pi agent runtime](https://docs.clawdbrain.bot/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.clawdbrain.bot/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.clawdbrain.bot/concepts/groups).
- [Media pipeline](https://docs.clawdbrain.bot/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.clawdbrain.bot/nodes/audio).

### Channels
- [Channels](https://docs.clawdbrain.bot/channels): [WhatsApp](https://docs.clawdbrain.bot/channels/whatsapp) (Baileys), [Telegram](https://docs.clawdbrain.bot/channels/telegram) (grammY), [Slack](https://docs.clawdbrain.bot/channels/slack) (Bolt), [Discord](https://docs.clawdbrain.bot/channels/discord) (discord.js), [Google Chat](https://docs.clawdbrain.bot/channels/googlechat) (Chat API), [Signal](https://docs.clawdbrain.bot/channels/signal) (signal-cli), [iMessage](https://docs.clawdbrain.bot/channels/imessage) (imsg), [BlueBubbles](https://docs.clawdbrain.bot/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.clawdbrain.bot/channels/msteams) (extension), [Matrix](https://docs.clawdbrain.bot/channels/matrix) (extension), [Zalo](https://docs.clawdbrain.bot/channels/zalo) (extension), [Zalo Personal](https://docs.clawdbrain.bot/channels/zalouser) (extension), [WebChat](https://docs.clawdbrain.bot/web/webchat).
- [Group routing](https://docs.clawdbrain.bot/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.clawdbrain.bot/channels).

### Apps + nodes
- [macOS app](https://docs.clawdbrain.bot/platforms/macos): menu bar control plane, [Voice Wake](https://docs.clawdbrain.bot/nodes/voicewake)/PTT, [Talk Mode](https://docs.clawdbrain.bot/nodes/talk) overlay, [WebChat](https://docs.clawdbrain.bot/web/webchat), debug tools, [remote gateway](https://docs.clawdbrain.bot/gateway/remote) control.
- [iOS node](https://docs.clawdbrain.bot/platforms/ios): [Canvas](https://docs.clawdbrain.bot/platforms/mac/canvas), [Voice Wake](https://docs.clawdbrain.bot/nodes/voicewake), [Talk Mode](https://docs.clawdbrain.bot/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.clawdbrain.bot/platforms/android): [Canvas](https://docs.clawdbrain.bot/platforms/mac/canvas), [Talk Mode](https://docs.clawdbrain.bot/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.clawdbrain.bot/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation
- [Browser control](https://docs.clawdbrain.bot/tools/browser): dedicated clawd Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.clawdbrain.bot/platforms/mac/canvas): [A2UI](https://docs.clawdbrain.bot/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.clawdbrain.bot/nodes): camera snap/clip, screen record, [location.get](https://docs.clawdbrain.bot/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.clawdbrain.bot/automation/cron-jobs); [webhooks](https://docs.clawdbrain.bot/automation/webhook); [Gmail Pub/Sub](https://docs.clawdbrain.bot/automation/gmail-pubsub).
- [Skills platform](https://docs.clawdbrain.bot/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety
- [Channel routing](https://docs.clawdbrain.bot/concepts/channel-routing), [retry policy](https://docs.clawdbrain.bot/concepts/retry), and [streaming/chunking](https://docs.clawdbrain.bot/concepts/streaming).
- [Presence](https://docs.clawdbrain.bot/concepts/presence), [typing indicators](https://docs.clawdbrain.bot/concepts/typing-indicators), and [usage tracking](https://docs.clawdbrain.bot/concepts/usage-tracking).
- [Models](https://docs.clawdbrain.bot/concepts/models), [model failover](https://docs.clawdbrain.bot/concepts/model-failover), and [session pruning](https://docs.clawdbrain.bot/concepts/session-pruning).
- [Security](https://docs.clawdbrain.bot/gateway/security) and [troubleshooting](https://docs.clawdbrain.bot/channels/troubleshooting).

### Ops + packaging
- [Control UI](https://docs.clawdbrain.bot/web) + [WebChat](https://docs.clawdbrain.bot/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.clawdbrain.bot/gateway/tailscale) or [SSH tunnels](https://docs.clawdbrain.bot/gateway/remote) with token/password auth.
- [Nix mode](https://docs.clawdbrain.bot/install/nix) for declarative config; [Docker](https://docs.clawdbrain.bot/install/docker)-based installs.
- [Doctor](https://docs.clawdbrain.bot/gateway/doctor) migrations, [logging](https://docs.clawdbrain.bot/logging).
...
- **[Gateway WebSocket network](https://docs.clawdbrain.bot/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.clawdbrain.bot/gateway)).
- **[Tailscale exposure](https://docs.clawdbrain.bot/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.clawdbrain.bot/gateway/remote)).
- **[Browser control](https://docs.clawdbrain.bot/tools/browser)** — clawd‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.clawdbrain.bot/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.clawdbrain.bot/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.clawdbrain.bot/nodes/voicewake) + [Talk Mode](https://docs.clawdbrain.bot/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.clawdbrain.bot/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Clawdbrain can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
Notes:
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Clawdbrain enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.clawdbrain.bot/gateway/tailscale) · [Web surfaces](https://docs.clawdbrain.bot/web)
...
Details: [Remote access](https://docs.clawdbrain.bot/gateway/remote) · [Nodes](https://docs.clawdbrain.bot/nodes) · [Security](https://docs.clawdbrain.bot/gateway/security)
...
Details: [Nodes](https://docs.clawdbrain.bot/nodes) · [macOS app](https://docs.clawdbrain.bot/platforms/macos) · [Gateway protocol](https://docs.clawdbrain.bot/concepts/architecture)
...
Details: [Session tools](https://docs.clawdbrain.bot/concepts/session-tool)
...
- Controlled via `clawdbrain nodes …`.

Runbook: [iOS connect](https://docs.clawdbrain.bot/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.clawdbrain.bot/platforms/android).
...
Minimal `~/.clawdbrain/clawdbrain.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.clawdbrain.bot/gateway/configuration)
...
Details: [Security guide](https://docs.clawdbrain.bot/gateway/security) · [Docker + sandboxing](https://docs.clawdbrain.bot/install/docker) · [Sandbox config](https://docs.clawdbrain.bot/gateway/configuration)

### [WhatsApp](https://docs.clawdbrain.bot/channels/whatsapp)

- Link the device: `pnpm clawdbrain channels login` (stores creds in `~/.clawdbrain/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.clawdbrain.bot/channels/telegram)
...
### [Slack](https://docs.clawdbrain.bot/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.clawdbrain.bot/channels/discord)
...
### [Signal](https://docs.clawdbrain.bot/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.clawdbrain.bot/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.clawdbrain.bot/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.clawdbrain.bot/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.clawdbrain.bot)
- [Read the architecture overview for the gateway + protocol model.](https://docs.clawdbrain.bot/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.clawdbrain.bot/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.clawdbrain.bot/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.clawdbrain.bot/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.clawdbrain.bot/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.clawdbrain.bot/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.clawdbrain.bot/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.clawdbrain.bot/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.clawdbrain.bot/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.clawdbrain.bot/platforms/windows), [Linux](https://docs.clawdbrain.bot/platforms/linux), [macOS](https://docs.clawdbrain.bot/platforms/macos), [iOS](https://docs.clawdbrain.bot/platforms/ios), [Android](https://docs.clawdbrain.bot/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.clawdbrain.bot/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.clawdbrain.bot/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.clawdbrain.bot/gateway/discovery)
- [Bonjour/mDNS](https://docs.clawdbrain.bot/gateway/bonjour)
- [Gateway pairing](https://docs.clawdbrain.bot/gateway/pairing)
- [Remote gateway README](https://docs.clawdbrain.bot/gateway/remote-gateway-readme)
- [Control UI](https://docs.clawdbrain.bot/web/control-ui)
- [Dashboard](https://docs.clawdbrain.bot/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.clawdbrain.bot/gateway/health)
- [Gateway lock](https://docs.clawdbrain.bot/gateway/gateway-lock)
- [Background process](https://docs.clawdbrain.bot/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.clawdbrain.bot/tools/browser-linux-troubleshooting)
- [Logging](https://docs.clawdbrain.bot/logging)

## Deep dives

- [Agent loop](https://docs.clawdbrain.bot/concepts/agent-loop)
- [Presence](https://docs.clawdbrain.bot/concepts/presence)
- [TypeBox schemas](https://docs.clawdbrain.bot/concepts/typebox)
- [RPC adapters](https://docs.clawdbrain.bot/reference/rpc)
- [Queue](https://docs.clawdbrain.bot/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.clawdbrain.bot/tools/skills-config)
- [Default AGENTS](https://docs.clawdbrain.bot/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.clawdbrain.bot/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.clawdbrain.bot/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.clawdbrain.bot/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.clawdbrain.bot/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.clawdbrain.bot/reference/templates/TOOLS)
- [Templates: USER](https://docs.clawdbrain.bot/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.clawdbrain.bot/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.clawdbrain.bot/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.clawdbrain.bot/platforms/mac/voicewake)
- [iOS node](https://docs.clawdbrain.bot/platforms/ios)
- [Android node](https://docs.clawdbrain.bot/platforms/android)
- [Windows (WSL2)](https://docs.clawdbrain.bot/platforms/windows)
- [Linux app](https://docs.clawdbrain.bot/platforms/linux)

## Email hooks (Gmail)

- [docs.clawdbrain.bot/gmail-pubsub](https://docs.clawdbrain.bot/automation/gmail-pubsub)

## Clawd

Clawdbrain was built for **Clawd**, a space lobster AI assistant. 🦞
