...
**This fork (`uglyswap/openclawNV`) includes NVIDIA NIM provider support with 150+ models including Kimi K2.5, DeepSeek V3.2, MiniMax M2.1, GLM-4.7, and more.**

Prefer `pnpm` for builds from source. Bun is optional for running TypeScript directly.

```bash
git clone https://github.com/uglyswap/openclawNV.git
cd openclawNV
pnpm install
...
OpenClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**. Full security guide: [Security](https://docs.openclaw.ai/gateway/security)
...
- **[NVIDIA NIM Integration](https://github.com/uglyswap/openclawNV/blob/main/docs/providers/nvidia.md)** — Access to 150+ state-of-the-art LLM models including Kimi K2.5, DeepSeek V3.2, MiniMax M2.1, GLM-4.7, Llama 3.3, Qwen 3 Next, and more.
...
- Skills: `~/.openclaw/workspace/skills/<org>/<skill>/SKILL.md`.
...
## NVIDIA NIM Provider (Fork Enhancement)

This fork includes enhanced NVIDIA NIM provider support with:
- **150+ models** from NVIDIA's API platform
- **Kimi K2.5** - Multimodal MoE with 1T parameters
- **DeepSeek V3.2** - Advanced reasoning
- **MiniMax M2.1** - High-performance reasoning
- **GLM-4.7** - Chinese-optimized model
- **And 145+ more** from 25+ providers

See [NVIDIA provider documentation](https://github.com/uglyswap/openclawNV/blob/main/docs/providers/nvidia.md) for the complete model catalog and configuration.
