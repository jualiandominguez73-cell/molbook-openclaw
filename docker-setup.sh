...
export OPENCLAW_DOCKER_INSTALL_BREW="${OPENCLAW_DOCKER_INSTALL_BREW:-0}"
export OPENCLAW_DOCKER_BREW_FORMULAS="${OPENCLAW_DOCKER_BREW_FORMULAS:-}"
...
upsert_env "$ENV_FILE" \
  ...
  OPENCLAW_DOCKER_INSTALL_BREW \
  OPENCLAW_DOCKER_BREW_FORMULAS

echo "==> Building Docker image: $IMAGE_NAME"
docker build \
  --build-arg "OPENCLAW_DOCKER_APT_PACKAGES=${OPENCLAW_DOCKER_APT_PACKAGES}" \
  --build-arg "OPENCLAW_DOCKER_INSTALL_BREW=${OPENCLAW_DOCKER_INSTALL_BREW}" \
  --build-arg "OPENCLAW_DOCKER_BREW_FORMULAS=${OPENCLAW_DOCKER_BREW_FORMULAS}" \
  -t "$IMAGE_NAME" \
