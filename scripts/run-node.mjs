...
const compiler = env.CLAWDBRAIN_TS_COMPILER === "tsc" ? "tsc" : "tsgo";
...
const shouldBuild = () => {
  if (env.CLAWDBRAIN_FORCE_BUILD === "1") return true;
...
const logRunner = (message) => {
  if (env.CLAWDBRAIN_RUNNER_LOG === "0") return;
  process.stderr.write(`[clawdbrain] ${message}\n`);
};
