...
show_usage() {
    cat << EOF
clawlog - Clawdbrain Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Clawdbrain logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Clawdbrain logs flow through the macOS unified log (subsystem: com.clawdbrain).
