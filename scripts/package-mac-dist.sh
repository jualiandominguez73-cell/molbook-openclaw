...
# Output:
# - dist/Clawdbrain.app
# - dist/Clawdbrain-<version>.zip
# - dist/Clawdbrain-<version>.dmg
...
APP="$ROOT_DIR/dist/Clawdbrain.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Clawdbrain-$VERSION.zip"
DMG="$ROOT_DIR/dist/Clawdbrain-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Clawdbrain-$VERSION.notary.zip"
