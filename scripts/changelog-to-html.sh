...
if [[ -z "$version_content" ]]; then
  echo "<h2>Clawdbrain $VERSION</h2>"
  echo "<p>Latest Clawdbrain update.</p>"
  echo "<p><a href=\"https://github.com/clawdbrain/clawdbrain/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
