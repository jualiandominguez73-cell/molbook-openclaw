...
- `pnpm dev:gateway`
- Override target: `CLAWDBRAIN_CONTROL_UI_PROXY_TARGET=http://<host>:<port> VITE_CLAWDBRAIN_CONTROL_UI_DEFAULT_GATEWAY_URL=ws://<host>:<port> pnpm dev:gateway`
- Optional password (still not stored): `CLAWDBRAIN_CONTROL_UI_DEFAULT_GATEWAY_PASSWORD=... pnpm dev:gateway`
