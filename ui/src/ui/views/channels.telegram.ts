        ...
        : html`
            <div class="status-list" style="margin-top: 16px;">
              ...
              <div>
                ...
                <span>${telegram?.mode ?? "暂无"}</span>
              </div>
              <div>
                <span class="label">上次启动</span>
                <span>${telegram?.lastStartAt ? formatAgo(telegram.lastStartAt) : "暂无"}</span>
              </div>
              <div>
                <span class="label">上次探测</span>
                <span>${telegram?.lastProbeAt ? formatAgo(telegram.lastProbeAt) : "暂无"}</span>
              </div>
            </div>
          `}
