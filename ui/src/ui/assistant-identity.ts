...
declare global {
  interface Window {
    __CLAWDBRAIN_ASSISTANT_NAME__?: string;
    __CLAWDBRAIN_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__CLAWDBRAIN_ASSISTANT_NAME__,
    avatar: window.__CLAWDBRAIN_ASSISTANT_AVATAR__,
  });
}
