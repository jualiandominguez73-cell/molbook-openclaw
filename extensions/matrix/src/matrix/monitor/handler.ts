...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("clawdbrain/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("clawdbrain/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "Clawdbrain: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
