...
import { removeAckReactionAfterReply, shouldAckReaction } from "clawdbrain/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/clawdbrain") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
