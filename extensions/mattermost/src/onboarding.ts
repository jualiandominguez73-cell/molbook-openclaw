import type { ChannelOnboardingAdapter, ClawdbrainConfig, WizardPrompter } from "clawdbrain/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.clawdbrain.bot/channels/mattermost",
    ].join("\n"),
