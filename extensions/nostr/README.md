...
Nostr DM channel plugin for Clawdbrain using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Clawdbrain. It enables your bot to:
...
# Configure clawdbrain to use local relay
