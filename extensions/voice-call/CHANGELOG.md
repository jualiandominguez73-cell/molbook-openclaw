...
### Changes
- Version alignment with core Clawdbrain release numbers.
...
### Highlights
- First public release of the @clawdbrain/voice-call plugin.
...
- CLI: `clawdbrain voicecall` commands (call/start/continue/speak/end/status/tail/expose).
