...
export function resolveTlonAccount(cfg: ClawdbrainConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: ClawdbrainConfig): string[] {
  const base = cfg.channels?.tlon as
