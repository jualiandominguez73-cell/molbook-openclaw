import type { ClawdbrainPluginApi, LineChannelData, ReplyPayload } from "clawdbrain/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ClawdbrainPluginApi): void {
  api.registerCommand({
    name: "card",
