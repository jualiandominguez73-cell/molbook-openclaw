...
service via the external `clawdbrain` CLI (no embedded runtime). This gives you
...
- The app installs a per‑user LaunchAgent labeled `com.clawdbrain.gateway`
