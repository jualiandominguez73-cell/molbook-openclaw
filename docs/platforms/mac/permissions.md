...
- Same path: run the app from a fixed location (for Clawdbrain, `dist/Clawdbrain.app`).
...
```bash
sudo tccutil reset Accessibility com.clawdbrain.mac
sudo tccutil reset ScreenCapture com.clawdbrain.mac
