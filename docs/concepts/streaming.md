...
Clawdbrain has two separate “streaming” layers:
...
When block streaming is enabled, Clawdbrain can **merge consecutive block chunks**
...
When draft streaming is active, Clawdbrain disables block streaming for that reply to avoid double-streaming.
