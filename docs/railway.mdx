...
Deploy Clawdbrain on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.app/new/template?template=https://github.com/vignesh07/clawdbrain-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/clawdbrain` — Control UI

## What you get

- Hosted Clawdbrain Gateway + Control UI
...
- `CLAWDBRAIN_STATE_DIR=/data/.clawdbrain` (recommended)
- `CLAWDBRAIN_WORKSPACE_DIR=/data/workspace` (recommended)
- `CLAWDBRAIN_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Clawdbrain state + workspace so you can migrate to another host without losing config or memory.
