...
read_when:
  - You are building a Clawdbrain plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (clawdbrain.plugin.json)

Every plugin **must** ship a `clawdbrain.plugin.json` file in the **plugin root**.
Clawdbrain uses this manifest to validate configuration **without executing plugin
