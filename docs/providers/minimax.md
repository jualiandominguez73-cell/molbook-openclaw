---
summary: "Use MiniMax M2.1 in Clawdbrain"
read_when:
  - You want MiniMax models in Clawdbrain
...
Configure manually via `clawdbrain.json`:
...
- Use `clawdbrain models list` and `clawdbrain models set minimax/MiniMax-M2.1` to switch.
...
- Running `clawdbrain configure` and selecting **MiniMax M2.1**, or
