---
summary: "Model providers (LLMs) supported by Clawdbrain"
read_when:
...
Clawdbrain can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `clawdbrain onboard`).
