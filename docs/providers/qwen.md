---
summary: "Use Qwen OAuth (free tier) in Clawdbrain"
read_when:
  - You want to use Qwen with Clawdbrain
...
```bash
clawdbrain models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Clawdbrain will sync credentials
