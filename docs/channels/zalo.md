...
- Install via CLI: `clawdbrain plugins install @clawdbrain/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `clawdbrain plugins install ./extensions/zalo`
   - From npm (if published): `clawdbrain plugins install @clawdbrain/zalo`
...
- Approve via:
  - `clawdbrain pairing list zalo`
  - `clawdbrain pairing approve zalo <CODE>`
...
- Example: `clawdbrain message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `clawdbrain channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawdbrain logs --follow`
