...
read_when:
  - You want Clawdbrain to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Clawdbrain to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`clawdbrain onboard`) and `clawdbrain channels add` list optional channel plugins.
...
```bash
clawdbrain plugins install @clawdbrain/nostr
```

Use a local checkout (dev workflows):

```bash
clawdbrain plugins install --link <path-to-clawdbrain>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "clawdbrain",
        "displayName": "Clawdbrain",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "clawdbrain@example.com",
        "lud16": "clawdbrain@example.com"
      }
    }
  }
}
