import type { BrowserConfig, BrowserProfileConfig, ClawdbrainConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a Clawdbrain browser profile (routing config), not a Chrome user profile.
