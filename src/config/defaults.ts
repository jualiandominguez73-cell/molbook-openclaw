...
function resolveAnthropicDefaultAuthMode(cfg: ClawdbrainConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyTalkApiKey(config: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyModelDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyLoggingDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyContextPruningDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyCompactionDefaults(cfg: ClawdbrainConfig): ClawdbrainConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
