...
export type ChannelAgentToolFactory = (params: { cfg?: ClawdbrainConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ClawdbrainConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ClawdbrainConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ClawdbrainConfig }) => boolean;
  supportsCards?: (params: { cfg: ClawdbrainConfig }) => boolean;
