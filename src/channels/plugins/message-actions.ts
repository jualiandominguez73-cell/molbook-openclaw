...
export function listChannelMessageActions(cfg: ClawdbrainConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ClawdbrainConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ClawdbrainConfig): boolean {
  for (const plugin of listChannelPlugins()) {
