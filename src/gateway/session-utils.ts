...
function listConfiguredAgentIds(cfg: ClawdbrainConfig): string[] {
...
export function listAgentsForGateway(cfg: ClawdbrainConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ClawdbrainConfig): string {
...
function resolveSessionStoreAgentId(cfg: ClawdbrainConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ClawdbrainConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ClawdbrainConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ClawdbrainConfig): GatewaySessionsDefaults {
