...
import type { loadClawdbrainPlugins } from "../plugins/loader.js";
...
export async function startGatewaySidecars(params: {
  ...
  pluginRegistry: ReturnType<typeof loadClawdbrainPlugins>;
  ...
  // Tests can opt out via CLAWDBRAIN_SKIP_CHANNELS (or legacy CLAWDBRAIN_SKIP_PROVIDERS).
  const skipChannels =
  ...
  if (!skipChannels) {
    ...
    params.logChannels.info(
      "skipping channel start (CLAWDBRAIN_SKIP_CHANNELS=1 or CLAWDBRAIN_SKIP_PROVIDERS=1)",
    );
  }
