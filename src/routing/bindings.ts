...
export function listBindings(cfg: ClawdbrainConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ClawdbrainConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ClawdbrainConfig) {
