...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option(
      "--auth-choice <choice>",
      "Auth: setup-token|token|chutes|openai-codex|openai-api-key|openrouter-api-key|ai-gateway-api-key|moonshot-api-key|kimi-code-api-key|synthetic-api-key|venice-api-key|gemini-api-key|zai-api-key|xiaomi-api-key|siliconflow-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|skip",
    )
    .option(
      "--token-provider <id>",
    ...
    .option("--siliconflow-api-key <key>", "SiliconFlow API key")
    .option("--siliconflow-site <site>", "SiliconFlow site: cn|global")
        ...
        await onboardCommand(
          {
            ...
            siliconflowSite: opts.siliconflowSite as "cn" | "global" | undefined,
