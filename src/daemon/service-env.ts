...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    CLAWDBRAIN_PROFILE: profile,
    CLAWDBRAIN_STATE_DIR: env.CLAWDBRAIN_STATE_DIR,
    CLAWDBRAIN_CONFIG_PATH: env.CLAWDBRAIN_CONFIG_PATH,
    CLAWDBRAIN_GATEWAY_PORT: String(port),
    CLAWDBRAIN_GATEWAY_TOKEN: token,
    CLAWDBRAIN_LAUNCHD_LABEL: resolvedLaunchdLabel,
    CLAWDBRAIN_SYSTEMD_UNIT: systemdUnit,
    CLAWDBRAIN_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    CLAWDBRAIN_SERVICE_KIND: GATEWAY_SERVICE_KIND,
