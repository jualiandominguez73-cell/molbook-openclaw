...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "clawdbrain-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveClawdbrainPackageRoot } = await import("./clawdbrain-root.js");
    ...
    vi.mocked(resolveClawdbrainPackageRoot).mockResolvedValue("/opt/clawdbrain");
