...
export function resolveTtsConfig(cfg: ClawdbrainConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.CLAWDBRAIN_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: ClawdbrainConfig): string | undefined {
