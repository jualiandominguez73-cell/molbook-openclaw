...
import {
  ...
  type ClawdbrainPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @clawdbrain/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageClawdbrain: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverClawdbrainPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".clawdbrain", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
