...
function resolveMentionPatterns(cfg: ClawdbrainConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: ClawdbrainConfig | undefined, agentId?: string): RegExp[] {
