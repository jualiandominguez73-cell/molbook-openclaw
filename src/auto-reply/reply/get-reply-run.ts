...
const BARE_SESSION_RESET_PROMPT =
  "A new session was started via /new or /reset. Greet the user in your configured persona, if one is provided. Be yourself - use your defined voice, mannerisms, and mood. Keep it to 1-3 sentences and ask what they want to do. If the model currently in use differs from the default model in the system prompt, briefly state both in plain language ('default model: …, currently using: …') and clarify that the second is fallback; if they match, don't mention models. Do not mention internal steps, files, tools, or reasoning.";
