...
function resolveWatchPaths(workspaceDir: string, config?: ClawdbrainConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ClawdbrainConfig }) {
