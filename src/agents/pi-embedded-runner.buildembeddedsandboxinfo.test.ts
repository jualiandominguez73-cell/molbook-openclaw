...
const _ensureModels = (cfg: ClawdbrainConfig, agentDir: string) =>
  ensureClawdbrainModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/clawdbrain-sandbox",
      agentWorkspaceDir: "/tmp/clawdbrain-workspace",
      ...
      browser: {
        ...
        containerName: "clawdbrain-sbx-browser-test",
      },
