...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveClawdbrainAgentDir() returns mainAgentDir
    process.env.CLAWDBRAIN_STATE_DIR = tmpDir;
    process.env.CLAWDBRAIN_AGENT_DIR = mainAgentDir;
