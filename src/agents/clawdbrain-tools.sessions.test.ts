...
describe("sessions tools", () => {
  ...
  it("sessions_list filters kinds and includes messages", async () => {
    ...
    const tool = createClawdbrainTools().find((candidate) => candidate.name === "sessions_list");
    expect(tool).toBeDefined();
  ...
  it("sessions_tags sets and clears tags", async () => {
    ...
    const tool = createClawdbrainTools({ agentSessionKey: "main" }).find(
  ...
  it("sessions_history filters tool messages by default", async () => {
    ...
    const tool = createClawdbrainTools().find((candidate) => candidate.name === "sessions_history");
    expect(tool).toBeDefined();
