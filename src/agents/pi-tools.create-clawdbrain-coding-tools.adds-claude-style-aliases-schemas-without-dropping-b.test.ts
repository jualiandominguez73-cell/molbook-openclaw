...
describe("createClawdbrainCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createClawdbrainCodingTools({
      config,
    ...
    const anthropicTools = createClawdbrainCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createClawdbrainCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createClawdbrainCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
