...
function resolveAvatarSource(cfg: ClawdbrainConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ClawdbrainConfig, agentId: string): AgentAvatarResolution {
