...
vi.mock("./models-config.js", () => ({
  ensureClawdbrainModelsJson: vi.fn().mockResolvedValue({ agentDir: "/tmp", wrote: false }),
}));

vi.mock("./agent-paths.js", () => ({
  resolveClawdbrainAgentDir: () => "/tmp/clawdbrain",
}));
...
describe("loadModelCatalog", () => {
  ...
  it("returns partial results on discovery errors", async () => {
    ...
    const result = await loadModelCatalog({ config: {} as ClawdbrainConfig });
