...
export function summarizeExistingConfig(config: ClawdbrainConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.clawdbrain.bot/gateway/remote",
    "https://docs.clawdbrain.bot/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
