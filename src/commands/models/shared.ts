...
export async function updateConfig(
  mutator: (cfg: ClawdbrainConfig) => ClawdbrainConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: ClawdbrainConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: ClawdbrainConfig): Set<string> {
