...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/clawdbrain when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "clawdbrain");
  ...
  it("flags ~/clawdbrain when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "clawdbrain");
