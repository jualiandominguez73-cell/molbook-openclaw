...
import {
  ...
  SILICONFLOW_DEFAULT_VISION_MODEL_REF,
...
export function applySiliconflowProviderConfig(
  ...
  models[SILICONFLOW_DEFAULT_MODEL_REF] = {
    ...models[SILICONFLOW_DEFAULT_MODEL_REF],
    alias: models[SILICONFLOW_DEFAULT_MODEL_REF]?.alias ?? "DeepSeek V3.2",
  };
  models[SILICONFLOW_DEFAULT_VISION_MODEL_REF] = {
    ...models[SILICONFLOW_DEFAULT_VISION_MODEL_REF],
    alias: models[SILICONFLOW_DEFAULT_VISION_MODEL_REF]?.alias ?? "GLM-4.6V",
  };

  const providers = { ...cfg.models?.providers };
  const existingProvider = providers.siliconflow;
  const defaultProvider = buildSiliconflowProvider({
