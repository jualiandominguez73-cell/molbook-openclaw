  ...
  if (normalizedOpts.nonInteractive && normalizedOpts.acceptRisk !== true) {
    runtime.error(
      [
        ...
        "Read: https://docs.clawdbrain.bot/security",
        `Re-run with: ${formatCliCommand("clawdbrain onboard --non-interactive --accept-risk ...")}`,
      ].join("\n"),
    );
    runtime.exit(1);
    return;
  ...
  if (process.platform === "win32") {
    runtime.log(
      [
        ...
        "Guide: https://docs.clawdbrain.bot/windows",
      ].join("\n"),
    );
  }
