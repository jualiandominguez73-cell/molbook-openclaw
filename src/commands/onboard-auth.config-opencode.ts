...
export function applyOpencodeZenProviderConfig(cfg: ClawdbrainConfig): ClawdbrainConfig {
...
export function applyOpencodeZenConfig(cfg: ClawdbrainConfig): ClawdbrainConfig {
