...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ClawdbrainConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ClawdbrainConfig; env: NodeJS.ProcessEnv }): {
  cfg: ClawdbrainConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
